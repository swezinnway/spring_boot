...
<div class="container">
<h3>Item Sale Add</h3>
<form:form action="new_ItemSale.htm" method="post" modelAttribute="itemsale">

<div class="form-group col-sm-6" >
      <label for="itemstock">Item_Stock:</label>
      <form:select path="itemstock.id" class="form-control" placeholder="Enter Item_Stock">
	<c:forEach items="${itemsaleList }" var="its">
	<form:option value="${its.id }">${its.name }</form:option>
	</c:forEach>
